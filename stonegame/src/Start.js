  ...
  return (
    ...
    <div style={{
      ...
      <div style={contentColumnStyle}>
        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "clamp(11px,2.8vw,13px)", letterSpacing: "0.18em", margin: "0 0 10px", textAlign: "center" }}>
          돌멩이를 선택하세요
        </p>
        ...
        {/* 이름 */}
        <p style={{ color: "#fff", fontSize: "clamp(18px,4.8vw,22px)", fontWeight: 700, margin: "10px 0 0", textAlign: "center" }}>
          {crystal.name} 돌멩이
        </p>
        ...
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: 4, alignItems: "center" }}>
          ...
          {crystal.benefit && (
            <p style={{
              color: "#6bcb77", fontSize: "clamp(12px,3vw,13px)", fontWeight: 600, margin: "4px 0 0",
